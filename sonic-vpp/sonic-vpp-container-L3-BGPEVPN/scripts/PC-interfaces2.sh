...
${ROUTER1} sudo config interface startup Ethernet1
${ROUTER1} sudo config interface startup Ethernet2

${ROUTER2} sudo config interface ip add Ethernet0 10.0.1.0/31
${ROUTER2} sudo config interface startup Ethernet0
${ROUTER2} sudo config interface startup Ethernet1
${ROUTER2} sudo config interface startup Ethernet2
